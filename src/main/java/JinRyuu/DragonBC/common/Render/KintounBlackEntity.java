...
public class KintounBlackEntity extends KintounBaseEntity {
   ...
   public KintounBlackEntity(World var1) {
      super(var1);
      this.T = 0.05F;
   ...
   public KintounBlackEntity(World var1, double var2, double var4, double var6) {
      this(var1);
   ...
   public boolean attackEntityFrom(DamageSource var1, float var2) {
      if(this.isEntityInvulnerable()) {
         ...
         if(var3 || this.getDamageTaken() > 1.0F) {
   ...
   public void onUpdate() {
      ...
      if(this.worldObj.isRemote && this.isBoatEmpty) {
         ...
         if(this.riddenByEntity != null) {
            ...
            byte var20 = JRMCoreH.getByte((EntityPlayer)this.riddenByEntity, "jrmcAlign");
            if(var20 > 66) {
         ...
         if(!this.worldObj.isRemote) {
            ...
            if(var39 != null && !var39.isEmpty()) {
               for(int var19 = 0; var19 < var39.size(); ++var19) {
                  Entity var41 = (Entity)var39.get(var19);
                  if(var41 != this.riddenByEntity && var41.canBePushed() && var41 instanceof KintounBlackEntity) {
                     this.motionX = 0.0D;
                     this.motionY = 0.0D;
                     this.motionZ = 0.0D;
                  }
            ...
            for(int var40 = 0; var40 < 4; ++var40) {
               int var42 = MathHelper.floor_double(this.posX + ((double)(var40 % 2) - 0.5D) * 0.8D);
               ...
               for(int var22 = 0; var22 < 2; ++var22) {
                  ...
                  Block var24 = this.worldObj.getBlock(var42, var23, var21);
                  if(var24 == Blocks.snow) {
                     this.worldObj.setBlockToAir(var42, var23, var21);
                  } else if(var24 == Blocks.waterlily) {
                     this.worldObj.destroyBlockInWorldPartially(var42, var23, var21, 0, 0);
                  }
               }
            }
