...
public class KintounEntity extends KintounBaseEntity {
   ...
   public KintounEntity(World var1) {
      super(var1);
      this.T = 0.05F;
   ...
   public KintounEntity(World var1, double var2, double var4, double var6) {
      this(var1);
         ...
         if(!this.worldObj.isRemote) {
            ...
            if(var39 != null && !var39.isEmpty()) {
               for(int var19 = 0; var19 < var39.size(); ++var19) {
                  ...
                  if(var41 != this.riddenByEntity && var41.canBePushed() && var41 instanceof KintounEntity) {
                     this.motionX = 0.0D;
                     this.motionY = 0.0D;
                     this.motionZ = 0.0D;
                  }
