...
public class DragonBlockNamek01Block extends BlockContainer {
   ...
   public DragonBlockNamek01Block() {
      ...
      float var1 = 0.4F;
      this.setBlockBounds(0.5F - var1, 0.4F - var1, 0.5F - var1, 0.5F + var1, 0.4F + var1, 0.5F + var1);
   }
   ...
   public ItemStack getPickBlock(MovingObjectPosition var1, World var2, int var3, int var4, int var5) {
      Item var6 = ItemsDBC.ItemNamekDragonBlock;
         ...
         if(!var1.isRemote) {
            if(var1.getBlock(var2 + 1, var3, var4) == this) {
               if(var1.getBlock(var2 + 1, var3, var4 + 1) == this && var1.getBlock(var2 + 1, var3, var4 - 1) == this && var1.getBlock(var2 - 1, var3, var4) == this && var1.getBlock(var2 - 1, var3, var4 - 1) == this && var1.getBlock(var2 - 1, var3, var4 + 1) == this) {
                  if(!var1.isRemote) {
                     EntityPorunga var11 = new EntityPorunga(var1);
               ...
               if(!var1.isRemote) {
                  EntityPorunga var12 = new EntityPorunga(var1);
