...
public class SpacePod01Item extends Item {
   ...
   public SpacePod01Item(Block var1, ArmorMaterial var2, int var3, int var4) {
   ...
   public boolean onItemUse1(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10) {
      var3.getBlock(var4, var5, var6);
      return true;
   }
   ...
   public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10) {
      ...
      if(!var2.canPlayerEdit(var4, var5, var6, var7, var1)) {
         ...
         if(!var3.isRemote) {
            ...
            SpacePod01Entity var11 = new SpacePod01Entity(var3);
