...
public class DBCGuiButtons05 extends GuiButton {
   public DBCGuiButtons05(int var1, int var2, int var3, int var4, int var5, String var6) {
   ...
   public void drawButton(Minecraft var1, int var2, int var3) {
      if(this.visible) {
         ...
         ResourceLocation var5 = new ResourceLocation("jinryuudragonbc:guibutton05.png");
