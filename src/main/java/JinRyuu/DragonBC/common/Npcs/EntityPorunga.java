...
public class EntityPorunga extends EntityCreature {
   ...
   public EntityPorunga(World var1x) {
      super(var1x);
   ...
   public boolean interact(EntityPlayer var1x) {
      ...
      if(this.isEntityAlive()) {
         if(!this.worldObj.isRemote) {
            if(!this.granted) {
               this.granted = true;
               JRMCoreH.setInt(3, var1x, "jrmcWishes");
               JRMCoreH.setInt(1, var1x, "jrmcDrgn");
            }
         } else if(!this.granted) {
            this.granted = true;
            var1x.openGui(mod_DragonBC.instance, 3, var1x.worldObj, (int)this.posX, (int)this.posY, (int)this.posZ);
         }

         if(!this.worldObj.isRemote) {
            EntityPorunga2 var4 = new EntityPorunga2(var1x.worldObj);
