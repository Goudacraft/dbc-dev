...
public class EntityFreeza4 extends EntityDBCEvil {
   ...
   public EntityFreeza4(World var1) {
      super(var1);
   ...
   protected void applyEntityAttributes() {
      ...
      this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(3200.0D);
      this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(320.0D);
   }
   ...
   public void onDeath(DamageSource var1) {
      ...
      if(var2 instanceof EntityPlayer) {
         ((EntityPlayer)var2).addChatMessage((new ChatComponentTranslation(JRMCoreH.trlai("dbc.itemFreeSagaFre.d.4.line1"), new Object[0])).setChatStyle(JRMCoreH2.styl_wht));
