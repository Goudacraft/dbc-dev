...
public class RenderAuraRingRed extends RenderDBC {
   ...
   public void renderAuraRingRed(EntityAuraRingRed var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      ResourceLocation var15 = new ResourceLocation("jinryuudragonbc:auraringr.png");
   ...
   public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      this.renderAuraRingRed((EntityAuraRingRed)var1, var2, var4, var6, var8, var9);
   }
}
