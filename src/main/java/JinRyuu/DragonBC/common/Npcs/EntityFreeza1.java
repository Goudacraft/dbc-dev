...
public class EntityFreeza1 extends EntityDBCEvil {
   ...
   public EntityFreeza1(World var1) {
      super(var1);
   ...
   public void onDeath(DamageSource var1) {
      ...
      if(var2 instanceof EntityPlayer) {
         ((EntityPlayer)var2).addChatMessage((new ChatComponentTranslation(JRMCoreH.trlai("dbc.itemFreeSagaFre.d.1.line1"), new Object[0])).setChatStyle(JRMCoreH2.styl_wht));
