...
public class EntityFreeza2 extends EntityDBCEvil {
   ...
   public EntityFreeza2(World var1) {
      super(var1);
   ...
   protected void applyEntityAttributes() {
      ...
      this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(240.0D);
   }
   ...
   public void onDeath(DamageSource var1) {
      ...
      if(var2 instanceof EntityPlayer) {
         ((EntityPlayer)var2).addChatMessage((new ChatComponentTranslation(JRMCoreH.trlai("dbc.itemFreeSagaFre.d.2.line1"), new Object[0])).setChatStyle(JRMCoreH2.styl_wht));
