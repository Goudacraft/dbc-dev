...
public class RenderAuraRed extends RenderDBC {
   ...
   public void renderAuraRed(EntityAuraRed var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      ResourceLocation var13 = new ResourceLocation("jinryuudragonbc:aurar.png");
   ...
   public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      this.renderAuraRed((EntityAuraRed)var1, var2, var4, var6, var8, var9);
   }
}
