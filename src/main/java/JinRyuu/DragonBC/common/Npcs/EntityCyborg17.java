...
public class EntityCyborg17 extends EntityCyborgsInf {
   ...
   public EntityCyborg17(World var1) {
      super(var1);
   ...
   protected void applyEntityAttributes() {
      ...
      this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(12000.0D);
      this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(1200.0D);
   }
