...
public class x0WorldChunkManagerNamek extends WorldChunkManager {
   ...
   public x0WorldChunkManagerNamek(long var1, WorldType var3) {
      this();
      GenLayer[] var4 = x0GenLayerDBCNamek.makeTheWorld(var1, var3);
      var4 = this.getModdedBiomeGenerators(var3, var1, var4);
      this.genBiomes = var4[0];
      this.biomeIndexLayer = var4[1];
   }

   public x0WorldChunkManagerNamek(World var1) {
