...
public class x2ChunkProviderTC implements IChunkProvider {
   ...
   public x2ChunkProviderTC(World var1, long var2, boolean var4) {
      this.worldObj = var1;
   ...
   public void genBiomeModdedTerrain(BiomeGenBaseDBC var1, World var2, Random var3, Block[] var4, byte[] var5, int var6, int var7, double var8) {
      ...
      for(int var18 = 255; var18 >= 0; --var18) {
         ...
         Block var21 = var4[var19];
         if(var18 > 31 && var18 < 200 && var21 == Blocks.stone) {
            var4[var19] = Blocks.air;
         }

         if(var18 <= 31 && var18 > 0 && var21 == Blocks.stone) {
            var4[var19] = BlocksDBC.BlockTCFloor;
         }

         if(var18 < 200 && var21 == Blocks.water) {
            var4[var19] = Blocks.air;
         }
      }
