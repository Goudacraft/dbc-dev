...
public class x1ChunkProviderOW implements IChunkProvider {
   ...
   public x1ChunkProviderOW(World var1, long var2, boolean var4) {
      this.worldObj = var1;
   ...
   public void genBiomeModdedTerrain(BiomeGenBaseDBC var1, World var2, Random var3, Block[] var4, byte[] var5, int var6, int var7, double var8) {
      ...
      for(int var19 = 255; var19 >= 0; --var19) {
         int var20 = (var16 * 16 + var15) * var17 + var19;
         if(var19 == 1) {
            var4[var20] = Blocks.lava;
         } else if(var19 <= 0 + var3.nextInt(5)) {
            var4[var20] = Blocks.bedrock;
         } else {
            Block var21 = var4[var20];
            if(var21 != null && var21.getMaterial() != Material.air) {
               if(var21 == Blocks.stone) {
                  if(var13 == -1) {
                     if(var14 <= 0) {
                        var10 = null;
                        var11 = 0;
                     ...
                     if(var19 < 63 && (var10 == null || var10.getMaterial() == Material.air)) {
                        if(var1.getFloatTemperature(var6, var19, var7) < 0.15F) {
                           var10 = Blocks.ice;
                           var11 = 0;
                        } else {
                           var10 = Blocks.water;
                     ...
                     if(var19 >= 62) {
                        var4[var20] = var10;
                        var5[var20] = var11;
                     } else if(var19 < 56 - var14) {
                        var10 = null;
                        var12 = Blocks.stone;
                        var4[var20] = Blocks.gravel;
                     } else {
                        var4[var20] = var12;
                     }
                  } else if(var13 > 0) {
                     ...
                     if(var13 == 0 && var12 == Blocks.sand) {
                        var13 = var3.nextInt(4) + Math.max(0, var19 - 63);
                  ...
                  if(var18 == 0) {
                     var18 = var19;
                  } else if(var18 != 0 && var18 - hch < var19) {
                     if(var18 >= var19 && var18 - 3 <= var19) {
                        var4[var20] = var1.topBlock;
                     } else if(var18 - hch + 1 >= var19 && var18 - hch + 1 <= var19) {
                        var4[var20] = Blocks.dirt;
                     } else {
                        var4[var20] = Blocks.air;
                     }
                  }
               }
            } else {
         ...
         Block var22 = var4[var20];
         if(var19 < 200 && var22 == Blocks.water) {
            var4[var20] = Blocks.air;
         }
      }
   ...
   public List getPossibleCreatures(EnumCreatureType var1, int var2, int var3, int var4) {
      ...
      int var6 = (new Random()).nextInt(50);
      return (List)(var1 == EnumCreatureType.monster && this.scatteredFeatureGenerator.func_143030_a(var2, var3, var4)?this.scatteredFeatureGenerator.getScatteredFeatureSpawnList():(var6 == 0?var5.getSpawnableList(var1):new ArrayList()));
   }
