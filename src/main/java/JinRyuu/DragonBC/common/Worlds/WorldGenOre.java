...
public class WorldGenOre extends WorldGenerator {
   ...
   public WorldGenOre(Block var1, int var2, Block var3) {
      this.field_150519_a = var1;
      this.numberOfBlocks = var2;
      this.field_150518_c = var3;
   }

   public WorldGenOre(Block var1, int var2, int var3, Block var4) {
      this(var1, var3, var4);
      this.mineableBlockMeta = var2;
   }
               ...
               for(int var41 = var33; var41 <= var36; ++var41) {
                  ...
                  if(var39 * var39 + var42 * var42 < 1.0D) {
                     for(int var44 = var34; var44 <= var37; ++var44) {
                        ...
                        if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && var1.getBlock(var38, var41, var44).isReplaceableOreGen(var1, var38, var41, var44, this.field_150518_c)) {
                           var1.setBlock(var38, var41, var44, this.field_150519_a, this.mineableBlockMeta, 2);
                        }
                     }
                  }
               }
